...
<head>
    <meta charset="utf-8">
    <title>文章分类：${typeInfo.name}</title>
                ...
                <c:forEach items="${pageInfo.list}" var="entity" varStatus="status">
                    <div class="block block2">
                        <div class="grid-5-7" style="height: 250px;">
                            ...
                            <div class="main-15">
                                <h4><a href="${pageContext.request.contextPath}/portal/type.action?typeId=${entity.typeInfo.id}">${entity.typeInfo.name}</a></h4>
                                ...
                                <div class="day"><fmt:formatDate value="${entity.updateTime}" type="date" pattern="yyyy-MM-dd"/></div>
                            </div>
                        </div>
                    </div>
                </c:forEach>
...
<script>
    ...
    javaex.page({
        ...
        callback:function(rtn) {
            window.location.href = "${pageContext.request.contextPath}/portal/type.action?pageNum=" + rtn.pageNum + "&typeId=${typeInfo.id}";
        }
    });
</script>
</html>
