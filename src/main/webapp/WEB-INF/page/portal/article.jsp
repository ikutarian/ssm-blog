...
<div class="header">
    ...
    <h4 id="article-time"><fmt:formatDate value="${articleInfo.updateTime}" type="date" pattern="yyyy-MM-dd"/></h4>
</div>
        ...
        <div class="grid-1-2-1">
            ...
            <div id="main-content" style="min-width: 950px;margin-top: 100px;margin-bottom: 40px;">
                <div class="content-header">
                    ...
                    <span class="active"><a href="${pageContext.request.contextPath}/portal/type.action?typeId=${articleInfo.typeInfo.id}">${articleInfo.typeInfo.name}</a></span>
                    <span class="divider">/</span>
